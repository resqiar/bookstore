...
function renderData(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    newElem.innerHTML = `
      <div class="max-w-[200px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="rounded-t-lg w-full h-full" src="${current.imageURL}" alt="${current.title}" />
        </a>
        <div class="p-5">
